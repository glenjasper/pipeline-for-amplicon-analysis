...
# Taxonomy database
silva_db_fa=SILVA_138.1_SSURef_NR99_tax_silva.fasta
silva_db_bin=silva_db
...
for R in *_R1_001.fastq ; do
  ...
  $FASTQC -f fastq -o ${samples_path} ${prefix}.merged.fq
  ...
  $FASTQC -f fastq -o ${samples_path} ${prefix}.filtered.fq
